...
EST_SETTINGS="est_method 1 est_ransac_reproj_thresh 50 est_n_model_pts 4 est_max_iters 100 est_max_subset_attempts 300 est_use_boost_rng 0 est_confidence 0.995 est_refine 1 est_lm_max_iters 10"
...
TRACKING_DATA_FNAME=gridcv10rLMS100i25p_ssd50r30i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
