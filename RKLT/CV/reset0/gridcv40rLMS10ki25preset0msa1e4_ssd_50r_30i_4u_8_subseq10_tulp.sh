...
EST_SETTINGS="est_method 1 est_ransac_reproj_thresh 50 est_n_model_pts 4 est_max_iters 10000 est_max_subset_attempts 10000 est_use_boost_rng 0 est_confidence 0.995 est_refine 1 est_lm_max_iters 10"
...
TRACKING_DATA_FNAME=gridcv40rLMS10ki25preset0msa1e4_ssd50r30i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
