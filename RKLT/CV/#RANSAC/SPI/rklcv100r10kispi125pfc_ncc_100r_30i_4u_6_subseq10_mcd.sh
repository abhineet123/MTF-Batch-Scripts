...
RKL_SETTINGS="rkl_sm fc rkl_enable_spi 1 rkl_enable_feedback 1 rkl_failure_detection 0 rkl_failure_thresh 15.0"
...
ACTOR_IDS=(0 1 2)
N_SUB_SEQ=10
EXEC_NAME=runMTF_vspi
TRACKING_DATA_FNAME=rklcv100r10kispi125pfc_ncc100r30i4u_6_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
