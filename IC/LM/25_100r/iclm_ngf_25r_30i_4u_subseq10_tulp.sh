...
IC_SETTINGS="sec_ord_hess 0 ic_update_ssm 0 leven_marq 1 lm_delta_init 0.01 lm_delta_update 10 ic_chained_warp 1 ic_hess_type  0"
...
TRACKING_DATA_FNAME=iclmcw1C1_ngf25r30i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
