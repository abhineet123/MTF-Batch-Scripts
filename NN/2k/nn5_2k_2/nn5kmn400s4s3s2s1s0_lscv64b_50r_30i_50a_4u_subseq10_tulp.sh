...
NNK_SETTINGS="nnk_n_layers 5 nnk_ssm_sigma_ids 4 nnk_ssm_sigma_ids 3 nnk_ssm_sigma_ids 2 nnk_ssm_sigma_ids 1 nnk_ssm_sigma_ids 0"
...
TRACKING_DATA_FNAME=nn5kmn400s4s3s2s1s0_lscv64b50r1i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
