...
FC_SETTINGS="sec_ord_hess 0 fc_chained_warp 1 fc_hess_type 0 leven_marq 0 lm_delta_init 0.01 lm_delta_update 10 fc_write_ssm_updates 0 fc_show_grid 0 fc_show_patch 0 fc_patch_resize_factor 4 enable_learning 0 fc_debug_mode 0"
...
TRACKING_DATA_FNAME=fcihcw1C1_riu50r30i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
