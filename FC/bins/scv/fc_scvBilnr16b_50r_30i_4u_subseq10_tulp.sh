...
SCV_SETTINGS="scv_hist_type 1 scv_n_bins 16 scv_preseed 0 scv_pou 1 scv_weighted_mapping 0 scv_mapped_gradient 0 scv_affine_mapping 1 scv_once_per_frame 0 scv_approx_dist_feat 0"
...
TRACKING_DATA_FNAME=fccw1C1_scvBilnr16b50r30i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
