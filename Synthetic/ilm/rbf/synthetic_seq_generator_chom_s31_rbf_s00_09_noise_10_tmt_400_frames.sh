...
SYN_SETTINGS="syn_ssm c8 syn_ilm rbf syn_grayscale_img 1 syn_continuous_warping 1 syn_warp_entire_image 1 syn_background_type 0 syn_use_inv_warp 1 syn_ssm_sigma_ids 31 syn_ssm_mean_ids -1 syn_am_sigma_ids 11 syn_am_mean_ids -1 syn_am_on_obj 1 syn_pix_sigma 0 syn_n_frames 400 syn_add_noise 1 syn_noise_mean 0 syn_noise_sigma 10 syn_save_as_video 0 syn_video_fps 24 syn_jpg_quality 25 syn_show_output 0"
RBF_SETTINGS="rbf_additive_update 1 rbf_n_ctrl_pts_x 3 rbf_n_ctrl_pts_y 3"
...
while [ $SYN_AM_SIGMA_IDS_IDX -lt ${N_SYN_AM_SIGMA_IDS} ]; do	
	...
	while [ $SEQ_IDS_IDX -lt ${N_SEQ} ]; do	
		...
		$EXEC_NAME actor_id $ACTOR_ID source_id $SEQ_ID $SETTINGS $SYN_SETTINGS $CHOM_SETTINGS $RBF_SETTINGS syn_am_sigma_ids $SYN_AM_SIGMA_ID	
