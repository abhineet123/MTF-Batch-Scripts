...
SYN_SETTINGS="syn_ssm 6 syn_ilm rbf syn_grayscale_img 1 syn_continuous_warping 1 syn_ssm_sigma_ids 25 syn_ssm_mean_ids 0 syn_am_sigma_ids 9 syn_am_mean_ids 0 syn_pix_sigma 0 syn_warp_entire_image 1 syn_background_type 0 syn_use_inv_warp 1 syn_out_suffix #warped_c8_s20 syn_n_frames 400 syn_add_noise 1 syn_noise_mean 0 syn_noise_sigma 10 syn_save_as_video 0 syn_video_fps 24 syn_jpg_quality 25 syn_show_output 0"
AFF_SETTINGS="aff_normalized_init 0 aff_pt_based_sampling 1"ACTORS=(TMT UCSB LinTrack PAMI LinTrackShort METAIO CMT VOT VOT16 VTB VIVID TrakMark TMT_FINE)
SYN_SSM_SIGMA_IDS=(94 95 96 97 98 99 100 101 102 103)
SEQ_IDS=(0 3 4 5 16 18 19)
ACTOR_ID=0
...
while [ $SYN_SSM_SIGMA_IDS_IDX -lt ${N_SYN_SSM_SIGMA_IDS} ]; do	
	...
	while [ $SEQ_IDS_IDX -lt ${N_SEQ} ]; do	
		...
		$EXEC_NAME actor_id $ACTOR_ID source_id $SEQ_ID $SETTINGS $SYN_SETTINGS $AFF_SETTINGS syn_ssm_sigma_ids $SYN_SSM_SIGMA_ID	
