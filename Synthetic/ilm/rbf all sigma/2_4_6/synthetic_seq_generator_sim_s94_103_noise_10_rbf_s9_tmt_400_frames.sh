...
SYN_SETTINGS="syn_ssm 4 syn_ilm rbf syn_grayscale_img 1 syn_continuous_warping 1 syn_ssm_sigma_ids 25 syn_ssm_mean_ids 0 syn_am_sigma_ids 9 syn_am_mean_ids 0 syn_pix_sigma 0 syn_warp_entire_image 1 syn_background_type 0 syn_use_inv_warp 1 syn_out_suffix #warped_c8_s20 syn_n_frames 400 syn_add_noise 1 syn_noise_mean 0 syn_noise_sigma 10 syn_save_as_video 0 syn_video_fps 24 syn_jpg_quality 25 syn_show_output 0"
SIM_SETTINGS="sim_normalized_init 0 sim_geom_sampling 0 sim_pt_based_sampling 1 sim_n_model_pts 2"
...
while [ $SYN_SSM_SIGMA_IDS_IDX -lt ${N_SYN_SSM_SIGMA_IDS} ]; do	
	...
	while [ $SEQ_IDS_IDX -lt ${N_SEQ} ]; do	
		...
		$EXEC_NAME actor_id $ACTOR_ID source_id $SEQ_ID $SETTINGS $SYN_SETTINGS $SIM_SETTINGS syn_ssm_sigma_ids $SYN_SSM_SIGMA_ID	
