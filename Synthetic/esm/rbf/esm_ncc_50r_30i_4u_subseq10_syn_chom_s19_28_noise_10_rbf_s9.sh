...
ESM_SETTINGS="sec_ord_hess 0 esm_chined_warp 1 esm_hess_type 1 leven_marq 0 lm_delta_init 0.01 lm_delta_update 10 esm_write_ssm_updates 0 esm_show_grid 0 esm_show_patch 0 esm_patch_resize_factor 4 enable_learning 0 esm_debug_mode 0"
...
TRACKING_DATA_FNAME=esmDJcw1C1_ncc50r30i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
