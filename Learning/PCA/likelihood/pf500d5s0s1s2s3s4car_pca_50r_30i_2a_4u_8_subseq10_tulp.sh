...
PCA_SETTINGS="pca_n_eigenvec 16 pca_batchsize 8 pca_f_factor 0.95 pca_show_basis 0 likelihood_alpha 2"
...
TRACKING_DATA_FNAME=pf500d5s0s1s2s3s4car_pca50r30i2a4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
