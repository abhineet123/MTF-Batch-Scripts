...
CMT_SETTINGS="cmt_estimate_scale 1 cmt_estimate_rotation 0 cmt_feat_detector FAST cmt_desc_extractor BRISK cmt_resize_factor 1"
...
TRACKING_DATA_FNAME=cmt3_50r30i4uNPP_4_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
