...
FA_SETTINGS="sec_ord_hess 0 leven_marq 0 lm_delta_init 0.01 lm_delta_update 10 fa_hess_type 1 enable_learning 0 fa_show_grid 0 fa_show_patch 0 fa_patch_resize_factor 2 fa_write_frames 0"
...
TRACKING_DATA_FNAME=faC1_ssim50r30i4uReinitGT_2_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
