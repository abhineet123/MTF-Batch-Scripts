...
DSST_SETTINGS="dsst_padding 1 dsst_sigma 0.0625 dsst_scale_sigma 0.25 dsst_lambda 1e-2 dsst_learning_rate 0.025 dsst_number_scales 33 dsst_scale_step 1.02 dsst_resize_factor 1 dsst_is_scaling 1 dsst_is_rotating 1 dsst_bin_size 1 dsst_number_rots 21 dsst_rot_step 2"
...
TRACKING_DATA_FNAME=dsst4r1_50r30i4u_4_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
