...
ESM_SETTINGS="sec_ord_hess 0 esm_jac_type 1 esm_hess_type  2 esm_chained_warp 1 leven_marq 0 lm_delta_init 0.01 lm_delta_update 10 esm_spi_enable 0 esm_spi_thresh 0.90"
