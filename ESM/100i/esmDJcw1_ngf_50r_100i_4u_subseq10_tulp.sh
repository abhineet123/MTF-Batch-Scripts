...
ESM_SETTINGS="sec_ord_hess 0 esm_jac_type 1 esm_hess_type  2 esm_chained_warp 1 enable_learning 0 leven_marq 0 lm_delta_init 0.01 lm_delta_update 10 esm_spi_enable 0 esm_spi_thresh 0.90"
...
TRACKING_DATA_FNAME=esmDJcw1C1_ngf50r100i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
