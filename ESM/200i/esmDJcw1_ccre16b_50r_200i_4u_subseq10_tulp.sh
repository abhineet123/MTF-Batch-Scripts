...
ESM_SETTINGS="sec_ord_hess 1 esm_jac_type 1 esm_hess_type 2 leven_marq 0 lm_delta_init 0.01 lm_delta_update 10 esm_chained_warp 1 enable_learning 0"
...
TRACKING_DATA_FNAME=esmDJcw1C2_ccre16b50r200i4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
