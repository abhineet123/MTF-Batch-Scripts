...
CCRE_SETTINGS="ccre_n_bins 6 ccre_pre_seed 10 ccre_pou 1 ccre_symmetrical_grad 0 ccre_n_blocks 1"
...
TRACKING_DATA_FNAME=pf500d5s0s1s2s3s4car_ccre6b50r30i100a1bt4u_8_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
