...
NCC_SETTINGS="ncc_fast_hess 0 likelihood_alpha 1 likelihood_beta 1 dist_from_likelihood 0"
...
TRACKING_DATA_FNAME=pf500d5s5s6s7s8s11car_ncc50r30i1a4u_sl3mean_0
N_ACTORS=${#ACTOR_IDS[@]}
ACTOR_IDS_IDX=0
